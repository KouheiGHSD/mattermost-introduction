...
ただ、当初こそ批判があったものの、このルールで運用を始め利用していくうちに
情報をオープンにすることによる効率化が見えはじめ、組織に定着していきました。

例えば、それまでクローズドに行っていた組織間のやりとりは、簡単なことでも資料を作成し打ち合わせを調整して話を進めていましたが、そういったことは行わずchatで気軽に会話して進めるケースも増えました。

従来の一部の人だけで話を進めていた時には、相手に提供するものがどう利用されるかわからず、認識祖語による問題を起こさないため資料を作っていたりしました。
これに対し、オープンな場所での会話は、何かあってもそこで話ができるし、自チームの人も見てくれているという感覚で、気軽に組織を超えての連携ができるようになりました。
...
このルールが定着したことで、一番変化があったのは「打ち合わせ」でした。
非同期で問題ない会話はchatで実施し、対面のほうがいい話は打ち合わせを行うことが多くなり
効率が上がりました。
...
ただ「chatに書くのは面倒。口頭で話をしたほうが早い」という人もいます。
