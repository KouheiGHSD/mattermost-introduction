...
Dockerコマンドで簡単に環境構築が可能で、チャットとしての操作性はもちろんのことHubotとの連携も問題なく行うことができ、何よりバックエンドにGo言語、フロントエンドがReact.jsという新しい技術を使って開発を進めているところに興味を持ちました。
ちょっとした翻訳ミスを報告したことから本体へのコントリビュートも行うようになり、その後、日本語翻訳の公式レビュワーやMattermost v4.6リリース時のMVPにも選ばれるなど、利用者としても開発者としても思い入れを深めていきました。
